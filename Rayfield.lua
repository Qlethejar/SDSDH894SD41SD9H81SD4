...
-- make all TextColor in this script becomes rainbo

-- make the theme dark grey
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			NotificationBackground = Color3.fromRGB(60, 60, 60),
			NotificationActionsBackground = Color3.fromRGB(70, 70, 70),

			TabBackground = Color3.fromRGB(40, 40, 40),
			TabStroke = Color3.fromRGB(50, 50, 50),
			TabBackgroundSelected = Color3.fromRGB(70, 70, 70),
			TabTextColor = Color3.fromRGB(220, 220, 220),
			SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

			ElementBackground = Color3.fromRGB(35, 35, 35),
			ElementBackgroundHover = Color3.fromRGB(40, 40, 40),
			SecondaryElementBackground = Color3.fromRGB(120, 120, 120), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(50, 50, 50),
			SecondaryElementStroke = Color3.fromRGB(50, 50, 50), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(85, 85, 85),
			SliderProgress = Color3.fromRGB(120, 120, 120),
			SliderStroke = Color3.fromRGB(60, 60, 60),

			ToggleBackground = Color3.fromRGB(100, 100, 100),
...
local function generateRandomName()
    ...
    local name = ""
    for i = 1, 2 do
        local randomChar = string.sub(characters, math.random(1, #characters), math.random(1, #characters))
...
if Rayfield.Parent == CoreGui then
    Rayfield.Name = randomname
end
...
TabList.Size = UDim2.new(0,471,0,50)
TabList.ScrollBarImageColor3 = Color3.new(240,240,240)
Elements.Template.UIListLayout.HorizontalAlignment = 'Left'
Elements.Template.ScrollBarThickness = 5
Elements.Template.ScrollBarImageTransparency = 0.7
Elements.Template.ScrollBarImageColor3 = Color3.new(240,240,240)
Elements.Template.Dropdown.List.ScrollingDirection = 'Y'
Elements.Template.Dropdown.List.ZIndex = 6
Elements.Template.Dropdown.List.ScrollBarThickness = 5
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				local Success, Response = pcall(function()
					...
					Input.InputFrame.InputBox.PlaceholderText = Input.InputFrame.InputBox.Text
				end)
				if not Success then
